...
!(function (e, t) {
        ...
        var n = [
          ...
          i = {
            ...
            then: function (t, r, i) {
              ...
              return b
                .Deferred(function (e) {
                  n[0][3].add(a(0, e, h(i) ? i : $, e.notifyWith)),
                    n[1][3].add(a(0, e, h(t) ? t : $)),
  ...
  function U(e) {
    return e.replace(F, "ms-").replace(B, z);
  }
  var X = function (e) {
  ...
  function Oe(e, t, n, r) {
    ...
    var i,
      ...
      v = t[0],
      m = h(v);
    if (m || (p > 1 && "string" == typeof v && !d.checkClone && Ae.test(v)))
  ...
  b.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        (a = ve(s, "script")).length > 0 && me(a, !u && ve(e, "script")), s
      );
    },
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = Ue(s)), (a = b.cssHooks[t] || b.cssHooks[s]), void 0 === n)
        )
        ...
        return "boolean" == typeof t && r
          ...
          : this.each(function () {
              ...
              if (r)
                ...
                (void 0 !== e && "boolean" !== n) ||
                  ((t = ht(this)) && G.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
  ...
  b.extend(b.event, {
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !p.noBubble && !g(r)) {
          for (
            u = p.delegateType || y, mt.test(u + y) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            m.push(a), (s = a);
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              ((s = r[l]) && (r[l] = null),
              (b.event.triggered = y),
              t.isPropagationStopped() && d.addEventListener(y, yt),
              r[y](),
              t.isPropagationStopped() && d.removeEventListener(y, yt),
  ...
  b.ajaxSetup({
    ...
    b.each(["top", "left"], function (e, t) {
      b.cssHooks[t] = We(d.pixelPosition, function (e, n) {
        if (n)
          return (n = _e(e, t)), Pe.test(n) ? b(e).position()[t] + "px" : n;
      });
    }),
  ...
  return (
    (b.noConflict = function (t) {
      return e.$ === b && (e.$ = Vt), t && e.jQuery === b && (e.jQuery = Xt), b;
    }),
  ...
  $(function () {
    ...
    function a(e, t) {
      e > t
        ? (n.addClass("fixed"),
          n.removeClass("relative"),
          $(".navbar__inner > img").attr(
            "src",
            "static/images/header/projeco-logo.png"
          ))
        : (n.removeClass("fixed"),
          n.addClass("relative"),
          $(".navbar__inner > img").attr(
            "src",
            "static/images/Navbar/projeco-logo-black.png"
          ));
    }
    a(o, i),
  ...
  $(function () {
    $(".nav-btn").on("click", function () {
      $(".nav__list").toggleClass("active"),
        $(".nav__list").hasClass("active") || $(".navbar").hasClass("fixed")
          ? $(".navbar__inner > img").attr(
              "src",
              "static/images/header/projeco-logo.png"
            )
  ...
  $(document).ready(function () {
    function e() {
      let e = $("body").innerWidth(),
        t = $(".nav__list");
      e >= 752 && t.removeClass("active");
    }
    e(),
